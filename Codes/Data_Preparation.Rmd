...
#import soep personal 2017 data - bhp
#personal <- read_dta("bhp.dta")
#personalLabels <- makeVlist(personal)

#import the dataset containing weights
#pweightdf <- read_dta("phrf.dta")
#hweightdf <- read_dta("hhrf.dta")
#hweightLabels <- makeVlist(hweightdf)


#import generated dataset for personal dataset
personal_gen <- read_dta("bhpgen.dta")
#personal_genLabels <- makeVlist(personal_gen)

#import soep household dataset for 2017 - bhh
#hh <- read_dta("bhh.dta")
#hhLabels <- makeVlist(hh)

#import generated dataset for bhh
hh_gen <- read_dta("bhhgen.dta")
#hh_genList <- makeVlist(hh_gen)

#import brutto dataset for household - NOT NEEDED
# hh_brutto <- read_dta("bhhbrutto.dta")
# hh_bruttoList <- makeVlist(hh_brutto)
